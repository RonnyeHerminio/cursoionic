...
import com.ronnye.cursomc.domain.Endereco;
import com.ronnye.cursomc.domain.Estado;
import com.ronnye.cursomc.domain.ItemPedido;
import com.ronnye.cursomc.domain.Pagamento;
import com.ronnye.cursomc.domain.PagamentoComBoleto;
import com.ronnye.cursomc.domain.PagamentoComCartao;
...
import com.ronnye.cursomc.repositories.ClienteRepository;
import com.ronnye.cursomc.repositories.EnderecoRepository;
import com.ronnye.cursomc.repositories.EstadoRepository;
import com.ronnye.cursomc.repositories.ItemPedidoRepository;
import com.ronnye.cursomc.repositories.PagamentoRepository;
import com.ronnye.cursomc.repositories.PedidoRepository;
import com.ronnye.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "rpherminio@hotmail.com", "123154545", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("77991137698", "77999787498"));
		Endereco e1 = new Endereco(null, "Rua flores", "300", "Apt 300", "Jardim", "212354", cli1, cid1);
		...
		Pagamento pagdo1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagdo1);
		Pagamento pagdo2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/10/2017 00:00"), null);
		ped2.setPagamento(pagdo2);
		
		cli1.getPedidos().addAll(Arrays.asList(ped1, ped2));
		
		pedidoRepository.saveAll(Arrays.asList(ped1,ped2));
		pagamentoRepository.saveAll(Arrays.asList(pagdo1,pagdo2));
